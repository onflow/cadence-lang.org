// Ported verbatim from the cadence-lang redesign (PR #306,
// src/components/MorphingAscii.tsx). The only change is the theme hook:
// next-themes -> Docusaurus' useColorMode. Everything else is unmodified.
//
// This module must not be imported during SSR - the module-level
// useGLTF.preload() calls need a browser. Load it via <BrowserOnly>.
