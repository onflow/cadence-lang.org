...
A transaction can atomically revert all of its action. It is possible for a transaction submitted by an untrusted party to post-select favorable results and revert the transaction for unfavorable results.
...
[commit-reveal schemes]: https://github.com/onflow/flips/pull/123
