...
## Capabilities and capability bootstrapping
...
A capability provided by one account to a second account must be able to be revoked by the first account without the co-operation of the second.
