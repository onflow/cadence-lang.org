...
:::tip
You can also append `.md` to any documentation URL to get the raw markdown for a single page. For example: [`https://cadence-lang.org/docs/language/resources.md`](/docs/language/resources.md)
:::
