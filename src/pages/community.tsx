...
// Ported from the cadence-lang redesign (PR #306, src/routes/community.tsx).
// Same mechanical changes as the homepage:
//   - fumadocs HomeLayout -> @theme/Layout (footer kept; this page has none
//     of its own, unlike the homepage)
//   - route `head` meta   -> Layout title/description + <Head> for og/twitter
//   - bg-[var(--accent)]  -> bg-accent (Tailwind v3 alpha support)
// Markup and copy are otherwise unchanged.

const TITLE = "Community";
const DESCRIPTION =
  "Join the Cadence community and contribute to the future of smart contract development.";
...
function SeoTags() {
  ...
  return (
    <Head>
      <link rel="canonical" href={`${base}/community`} />
      <meta property="og:title" content="Community | Cadence" />
      <meta property="og:description" content={DESCRIPTION} />
      <meta property="og:url" content={`${base}/community`} />
      <meta property="og:type" content="website" />
      <meta property="og:site_name" content="Cadence" />
      <meta property="og:logo" content={`${base}/img/logo.svg`} />
      <meta name="twitter:card" content="summary_large_image" />
      <meta name="twitter:title" content="Community | Cadence" />
...
function Community() {
  ...
  return (
    <Layout title={TITLE} description={DESCRIPTION} wrapperClassName="cadence-home">
      <SeoTags />
      <div className="relative min-h-screen bg-[#FAFAFA] dark:bg-black text-neutral-900 dark:text-white font-sans transition-colors duration-300 overflow-hidden">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[300px] bg-accent/10 rounded-full blur-[120px] pointer-events-none" />
        ...
        <div className="relative max-w-5xl mx-auto px-6 pt-32 pb-24 z-10">
          ...
          <div className="grid md:grid-cols-2 gap-6 relative z-10">
            {communityCards.map((card, idx) => (
              ...
              >
                <div className="absolute -inset-0.5 bg-gradient-to-r from-accent to-blue-500 rounded-2xl opacity-0 group-hover:opacity-20 transition duration-500 blur" />
                <div className="relative h-full bg-white dark:bg-[#0A0A0A] border border-black/10 dark:border-white/10 rounded-2xl p-8 transition-colors duration-300 hover:border-black/20 dark:hover:border-white/20">
                  ...
                  <div className="flex items-center gap-2 text-sm font-mono text-accent group-hover:translate-x-1 transition-transform">
          ...
          <div className="mt-24 relative rounded-2xl overflow-hidden group">
            <div className="absolute inset-0 bg-gradient-to-r from-accent/20 to-blue-500/20 backdrop-blur-3xl" />
