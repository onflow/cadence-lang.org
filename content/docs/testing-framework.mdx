...
[errors]: #errors
[Flow CLI configuration file]: https://developers.flow.com/tools/flow-cli/flow.json/configuration#contracts
[statically defining contract addresses]: https://developers.flow.com/tools/flow-cli/flow.json/configuration#advanced-format
